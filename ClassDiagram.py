...
class ClassDiagram():
    ...
    def set_Attribute_public(self,filename_input,  filename_output ,output_path,parameter,variables,primitivevariables,complexvariables,Relation):
        counter_import = []
         #if Instanz.set_import(filename_input) != None:
         #   T = Instanz.set_import(filename_input)
          #  counter_import.append(T)
    ...
    def set_Attribute_protected(self,filename_input,  filename_output ,output_path,parameter,variables,primitivevariables,complexvariables):
    ...
    def set_Methode(self,filename_input,filename_output,output_path,parameter,variables,primitivevariables,complexvariables,methode):
        #Counter_Equation = Instanz.set_Attribute_protected(filename_input, filename_output,output_path,parameter,variables,primitivevariables,complexvariables )
        self.readfile_in = open(filename_input,'r')
        readfile_out = open(filename_output,"a")
        array0 = []
        array01 = []
    ...
    def ClassName(self,filename_input,Package):
        self.readfile_in = open(filename_input,'r')
        stereotyp=[]
        ...
        #Stereotyp
            if len(Package)==0 :
                if len(x_array)>0:
                    if x_array[0] == 'package' and x_array[1]=="test":
            ...
            if len(Package)>0:
                ...
                if len(x_array)>0:
                    ...
                    if x_array[0] == "block":
                        stereotyp.append(x_array)
                        classname = "package "+ Package[0] +"{"+"Class "+stereotyp[0][1] + " << " +stereotyp[0][0]+ " >>  {"
                    ...
                    if x_array[0] == "connector":
                        ...
                        stereotyp.append(x_array)
                        classname = "package "+ Package[0] +"{"+"interface "+stereotyp[0][1] + " << " +stereotyp[0][0]+ " >>  {"
    ...
    def put_full_class(self,filename_input,output_path,parameter,variables,primitivevariables,complexvariables,methode,Package,showPackages,Relation):
        #print(filename_input)
        filenamelist = []
        filename_output = DataCheck.setUMLModell(filename_input, output_path)
        Instanz.set_Attribute_public(filename_input,filename_output, output_path,parameter,variables,primitivevariables,complexvariables,Relation)            
            ...
            if len(Package)>0 :
                ...
                if showPackages==True:
                    ...
                    for i in range(0,len(filename_package)-1,1):
                        ...
                        Instanz.set_Attribute_public(filename_package[i],filename_output, output_path,parameter,variables,primitivevariables,complexvariables,Relation)            
...
#Test.converter(filename_input)
#Test.class_name(r"C:\Users\sven-\Dropbox\AixLib-development_issue590\AixLib\Fluid\Actuators\Valves\ExpansionValves\BaseClasses\PartialExpansionValve.mo")   
  
if __name__ == "__main__":
    
    #filename_input  = r"C:\Users\sven-\Dropbox\AixLib-issue590_ExpansionValve\AixLib\Fluid\Actuators\Valves\ExpansionValves\BaseClasses\PartialExpansionValve.mo"
    #filename_output = r"C:\Users\sven-\Dropbox\AixLib-issue590_ExpansionValve\AixLib\Fluid\Actuators\Valves\ExpansionValves\BaseClasses"
    #filename_input=r"OutputDatei.txt"
    ...
    #Test.converter(filename_input, output_path)
    output_path=r"C:\Users\sven-\Dropbox\08_Eclipse_Workspace_Automated_Documentation\Automated_Documentation\UML_Diagram\Java_Klassen\TempData"
    filename_input = r"C:\Users\hinack\Dropbox\08_Eclipse_Workspace_Automated_Documentation\Automated_Documentation\UML_Diagram\Java_Klassen\TempData\PartialTwoPortTransport"
    RelationModel = "FluidPort_a"
 
    #Instanz.set_packages(filename_input, RelationModel,output_path)
   # Instanz.set_import(filename_input)
    #Instanz.set_Attribute_public