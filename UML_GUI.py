...
class Ui_MainWindow(QWidget):
    ...
    def initMe(self):
        ...
        self.comboBox.addItem("Other Diagram")
...
#
        ...
        try:
            ...
            print("start")  
            Interface.Class_Interface(filename_input,output_path,AixLib_path,HierarchyLevel,parameter,variables,primitivevariables,complexvariables,methode,block,showPackages,Relation)
